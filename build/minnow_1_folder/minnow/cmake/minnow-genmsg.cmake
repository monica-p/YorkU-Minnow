...
message(STATUS "minnow: 2 messages, 1 services")

set(MSG_I_FLAGS "-Iminnow:/home/monica/panda_work/src/minnow_1_folder/minnow/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/monica/panda_work/src/minnow_1_folder/minnow/msg/Boat.msg" NAME_WE)
add_custom_target(_minnow_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "minnow" "/home/monica/panda_work/src/minnow_1_folder/minnow/msg/Boat.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/monica/panda_work/src/minnow_1_folder/minnow/srv/command_val.srv" NAME_WE)
add_custom_target(_minnow_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "minnow" "/home/monica/panda_work/src/minnow_1_folder/minnow/srv/command_val.srv" ""
)

get_filename_component(_filename "/home/monica/panda_work/src/minnow_1_folder/minnow/msg/position.msg" NAME_WE)
add_custom_target(_minnow_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "minnow" "/home/monica/panda_work/src/minnow_1_folder/minnow/msg/position.msg" ""
)
...
_generate_srv_cpp(minnow
  "/home/monica/panda_work/src/minnow_1_folder/minnow/srv/command_val.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/minnow
)
