...
cd "/home/monica/panda_work/src/nmea_navsat_driver"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/monica/panda_work/src/nmea_navsat_driver/setup.py" \
    build --build-base "/home/monica/panda_work/build/nmea_navsat_driver" \
    install \
    $DESTDIR_ARG \
