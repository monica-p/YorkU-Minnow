...
if("FALSE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/monica/panda_work/src/gps_folder/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/monica/panda_work/devel)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /home/monica/panda_work/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/monica/panda_work/install/${idir}'.  Ask the maintainer 'Eric Perko <eric@ericperko.com>' to fix it.")
    endif()
