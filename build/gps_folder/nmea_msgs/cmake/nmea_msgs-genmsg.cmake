...
message(STATUS "nmea_msgs: 1 messages, 0 services")

set(MSG_I_FLAGS "-Inmea_msgs:/home/monica/panda_work/src/gps_folder/nmea_msgs/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/monica/panda_work/src/gps_folder/nmea_msgs/msg/Sentence.msg" NAME_WE)
add_custom_target(_nmea_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "nmea_msgs" "/home/monica/panda_work/src/gps_folder/nmea_msgs/msg/Sentence.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(nmea_msgs
  "/home/monica/panda_work/src/gps_folder/nmea_msgs/msg/Sentence.msg"
  "${MSG_I_FLAGS}"
